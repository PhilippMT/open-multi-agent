 ...
 * ### Single agent
 * ```ts
 * const orchestrator = new OpenMultiAgent({ defaultModel: 'claude-opus-4-5' })
 * const result = await orchestrator.runAgent(
 *   { name: 'assistant', model: 'claude-opus-4-5' },
 ...
 *   name: 'writers',
 *   agents: [
 *     { name: 'researcher', model: 'claude-opus-4-5', systemPrompt: 'You research topics thoroughly.' },
 *     { name: 'writer',     model: 'claude-opus-4-5', systemPrompt: 'You write clear documentation.' },
 *   ],
 *   sharedMemory: true,
 * })

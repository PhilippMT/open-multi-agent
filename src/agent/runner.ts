 ...
 *
 * The loop design is directly modeled on Claude Code's `query.ts` pattern:
...
export class AgentRunner {
  ...
  async *stream(
    ...
    try {
      // -----------------------------------------------------------------
      // Main agentic loop — mirrors Claude Code's queryLoop `while (true)`
      // -----------------------------------------------------------------
      while (true) {
        ...
        //
        // This mirrors Claude Code's `runTools` / `executeBatch` pattern.
